...
def build_graph():
    ...
    """
    load_dotenv()
    #primary_llm = ChatOpenAI(model=TOOLS_CFG.primary_agent_llm,temperature=TOOLS_CFG.primary_agent_llm_temperature)
    ...
    primary_llm=ChatGroq(groq_api_key=groq_api_key, model_name="llama-3.3-70b-versatile")
